...
namespace hyenae::frontend::console::states
{
    ...
    string_t icmp_v6_frame_setup::get_generator_name() const
    {
        return "ICMPv6-Frame";
    ...
    icmp_v6_frame_setup::data_generator_t*
        icmp_v6_frame_setup::get_generator() const
    {
        return _generator;
    ...
    void icmp_v6_frame_setup::update_generator()
    {
        safe_delete(_generator);
        
        _generator = new icmp_v6_frame_generator_t(
        ...
        {
            ((icmp_v6_frame_generator_t*)_generator)->
    ...
    void icmp_v6_frame_setup::on_select()
    {
    ...
    void icmp_v6_frame_setup::update_menu_items()
    {
    ...
    void icmp_v6_frame_setup::prompt_type()
    {
...
/*---------------------------------------------------------------------- */
    ...
    void icmp_v6_frame_setup::prompt_code()
    {
