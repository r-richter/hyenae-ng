...
namespace hyenae::model::generators::protocols
{
    ...
    icmp_v4_frame_generator::icmp_v4_frame_generator(
        uint8_t type,
        uint8_t code)
    {
        // Type
    ...
    generator_group* icmp_v4_frame_generator::get_payload()
    {
        return &_payload;
    ...
    size_t icmp_v4_frame_generator::data_size() const
    {
        return _packet.size();
    ...
    byte_t* icmp_v4_frame_generator::data_to_buffer(
